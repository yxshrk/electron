...
| Yash | InsForge + diagnosis + capture storage | [yash-insforge-diagnosis.md](./yash-insforge-diagnosis.md) | Schema, run source of truth, context/debug artifact ingest, bug report generation, diagnosis |
| Luke | Replicas + PR | [luke-replicas-dispatch-pr.md](./luke-replicas-dispatch-pr.md) | Dispatch confirmed hypotheses, collect evidence, open PR |
